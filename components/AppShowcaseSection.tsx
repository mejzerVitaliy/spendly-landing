...
const screens = [
  {
    ...
    description:
      "Your total balance, income vs expenses, and full transaction history — filterable by week, month, or year. Search any transaction instantly.",
    tag: "Home",
    color: "#22D3EE",
    icon: (
  ...
  },
  {
    ...
    title: "3 ways to add transactions",
    description:
      "Add manually, type in plain language with Text AI, or just speak with Voice AI. Spendly understands \"coffee 4.50\" as naturally as you do.",
    tag: "Add",
    color: "#22C55E",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    ...
    description:
      "Cash flow trends, income vs expense ratios, and a full breakdown by category. See exactly where your money goes, over any time period.",
    tag: "Analytics",
    color: "#818CF8",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    ...
    title: "Multiple wallets, one balance",
    description:
      "Cash, savings, or custom wallets — all balances unified and converted to your main currency in real time. 4 active wallets shown at once.",
    tag: "Wallets",
    color: "#C084FC",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    ...
    description:
      "Choose your main currency and pin favorites for quick wallet creation. Changing the main currency recalculates all balances instantly.",
    tag: "Currencies",
    color: "#EAB308",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
        <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.8"/>
        <path d="M12 3a14.5 14.5 0 0 1 0 18M12 3a14.5 14.5 0 0 0 0 18M3 12h18" stroke="currentColor" strokeWidth="1.8"/>
      </svg>
    ),
  },
  {
    ...
    description:
      "Pin up to 10 favorite categories for instant access when adding transactions. Separate lists for expenses and income.",
    tag: "Categories",
    color: "#F97316",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
...
export default function AppShowcaseSection() {
  ...
  return (
    <section id="app-showcase" className="py-32 relative overflow-hidden">
      {/* Background glow that follows active screen color */}
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20 animate-fade-up">
          ...
          <h2
            ...
            style={{ fontSize: "clamp(32px, 4.5vw, 56px)", color: "#F2F2F2" }}
          >
            See it in{" "}
            <span className="gradient-text">action</span>
          </h2>
          <p className="mt-4 text-lg max-w-xl mx-auto" style={{ color: "#737373" }}>
            Every screen, every feature — exactly as it looks on your phone.
          </p>
        </div>
              ...
              {screens.map((s, i) => (
                <button
                  ...
                  style={{
                    ...
                    background: i === active ? screen.color : "rgba(115,115,115,0.3)",
                  }}
                />
              ))}
            </div>
            ...
            <div className="relative" style={{ width: 320, height: 680 }}>
              ...
              <div
                ...
                style={{
                  background: "#0e0e0e",
                  boxShadow:
                    "0 0 0 1px rgba(255,255,255,0.10), inset 0 0 0 1px rgba(0,0,0,0.8), 0 40px 100px rgba(0,0,0,0.7)",
                  padding: "10px",
                }}
              >
                {/* Screen bezel */}
                ...
                >
                  ...
                  {/* All screenshots rendered at once — opacity toggle = no extra network requests */}
                  {screens.map((s, i) => (
                    <div
                      key={s.id}
                      style={{
